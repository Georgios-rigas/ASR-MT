...
if all(df is not None for df in [metrics_df, translations_df, finetuning_examples_df]):
    ...
    with tab1:
        ...
        if libraries_available:
            ...
            col1, _ = st.columns(2)
            with col1:
                st.subheader("Or select a local audio")
                ...
                selected_audio = st.selectbox("Select an audio file from dataset", options=["None"] + audio_files)
            ...
            if st.session_state.transcription_done:
                ...
                with col1:
                    ...
                    st.markdown("**Generated by Whisper Model**")
                ...
                with col2:
                    ...
                    st.markdown("**Generated by Opus Model**")
